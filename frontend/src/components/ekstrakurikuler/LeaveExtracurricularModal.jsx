...
export default function LeaveExtracurricularModal({
  isOpen,
  onClose,
  onConfirm,
  extracurricularName = "",
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-rose-600 truncate max-w-[220px]">
                {extracurricularName}
              </p>
            </div>
          </div>
          ...
          <div className="text-sm text-gray-600 leading-relaxed space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Anda dapat bergabung kembali selama kuota masih tersedia.
            </p>
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-2 border-t border-gray-100">
            ...
            <button
              ...
              onClick={onConfirm}
              disabled={isSubmitting}
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-bold bg-rose-600 text-white hover:bg-rose-700 transition-all shadow-md shadow-rose-500/20 active:scale-95 cursor-pointer disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
