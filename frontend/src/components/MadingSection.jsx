    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          {/* Right Column (Mobile: 1st, Desktop: 2nd): Title & Text */}
          <div className="order-1 lg:order-2 lg:col-span-7 flex flex-col items-start mading-animate-item">
            {/* Section Kicker */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-blue-50 border border-blue-100 text-[#2c1ee8] text-[10px] sm:text-[11px] font-mono tracking-widest uppercase mb-3.5 sm:mb-4 select-none max-w-full">
              <Newspaper className="w-3.5 h-3.5 text-[#2c1ee8] shrink-0" />
              <span className="font-semibold truncate">Informasi & Berita</span>
            </div>

            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 leading-[1.16] sm:leading-[1.12] mb-3 sm:mb-4">
          ...
          {/* Left Column (Mobile: 2nd, Desktop: 1st): 3D Floating Collage */}
          <div className="order-2 lg:order-1 lg:col-span-5 w-full flex justify-center lg:justify-start mading-animate-item">
        ...
        <div className="mt-10 sm:mt-14">
          ...
          {!isLoading && !isError && featuredArticle && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch mading-animate-item">
              {/* Featured Card (Left) with Spotlight Flare Effect */}
              <div
                ref={featuredCardRef}
                onMouseMove={handleMouseMove}
                className="relative lg:col-span-7 bg-white border border-slate-200/90 rounded-3xl p-4 sm:p-7 shadow-md flex flex-col justify-between group hover:shadow-xl hover:border-blue-300 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 sm:gap-6 items-center relative z-10">
                  <div className="sm:col-span-5 relative aspect-[16/10] sm:aspect-[4/3] w-full rounded-2xl overflow-hidden bg-slate-900 border border-slate-200/80 shadow-xs">
                    <Image
                      src={getArticleImage(
                        featuredArticle,
                  ...
                  <div className="sm:col-span-7 flex flex-col justify-between h-full">
                    <div>
                      <span className="inline-block bg-blue-50 text-[#2c1ee8] border border-blue-100 px-2.5 sm:px-3 py-1 rounded-lg text-[10px] sm:text-xs font-mono font-bold uppercase tracking-wider mb-2.5 sm:mb-3 shadow-2xs">
                        {featuredArticle.category || "Berita Utama"}
                      </span>
                      <h3 className="text-base sm:text-xl font-extrabold text-slate-900 leading-snug mb-2 tracking-tight line-clamp-2 group-hover:text-[#2c1ee8] transition-colors">
                        {featuredArticle.title}
                      </h3>
                      <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal mb-4 sm:mb-5 line-clamp-3">
              ...
              {highlightArticle && (
                <Link
                  ...
                  className="lg:col-span-5 relative rounded-3xl overflow-hidden shadow-md border border-slate-200/90 group cursor-pointer min-h-[220px] sm:min-h-[260px] flex flex-col justify-end p-5 sm:p-7 hover:shadow-xl transition-all duration-300 bg-slate-900"
                >
                  <Image
                    src={getArticleImage(
                      highlightArticle,
                  ...
                  <div className="relative z-20">
                    <span className="inline-block bg-white/90 backdrop-blur-md text-slate-900 text-[10px] sm:text-[11px] font-bold px-2.5 sm:px-3 py-1 rounded-lg mb-2 sm:mb-2.5 shadow-2xs">
                      {highlightArticle.category || "Pengumuman"}
                    </span>
                    <h3 className="text-base sm:text-xl font-extrabold text-white leading-snug line-clamp-2 drop-shadow-xs">
        ...
        <div className="mt-10 sm:mt-12 flex justify-center mading-animate-item">
          <Link
            href="/pengumuman"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#2c1ee8] hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-sm sm:text-base px-7 py-3.5 rounded-2xl shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer active:scale-[0.97] text-center"
          >
