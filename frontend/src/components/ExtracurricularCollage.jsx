...
export default function ExtracurricularCollage() {
  ...
  return (
    <div className="relative w-full max-w-[540px] mx-auto lg:mx-0 select-none">
      <div className="grid grid-cols-2 gap-3.5 sm:gap-4.5">
        {items.map((img, idx) => (
          <motion.div
            ...
            className="group relative aspect-square w-full overflow-hidden rounded-2xl sm:rounded-3xl bg-slate-100 border border-slate-200/60 shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer"
          >
            <Image
              src={img.src}
              alt={img.alt}
