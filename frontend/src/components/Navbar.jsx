              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`font-semibold text-base lg:text-lg transition-colors cursor-pointer relative py-1 ${
                      isActive
                        ? "text-[#2c1ee8]"
            ...
            <div className="hidden md:flex items-center gap-3">
              {isAuthenticated ? (
                <div className="flex items-center gap-3">
                  <Link
                    href="/profile"
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-[#2c1ee8] hover:bg-blue-100 font-semibold text-sm transition-all cursor-pointer"
                  >
                  ...
                  <button
                    onClick={logout}
                    className="p-2 text-gray-500 hover:text-red-600 rounded-full hover:bg-red-50 transition-colors cursor-pointer"
                    title="Keluar Sesi"
                  >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center border-2 border-[#2c1ee8] text-[#2c1ee8] hover:bg-[#2c1ee8] hover:text-white font-semibold text-base lg:text-lg px-7 py-2 rounded-full transition-all duration-300 hover:shadow-md hover:scale-[1.02] active:scale-95 cursor-pointer"
                >
                  Login
                </button>
              )}
