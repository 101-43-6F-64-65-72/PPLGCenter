...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260823130000_Add3DModelUrlToFacility') THEN
    ALTER TABLE "Facilities" ADD "Model3DUrl" character varying(500);
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
