...
**StudentCenter** is a web-based student information system for SMA/SMK schools, built with [[Clean Architecture]] principles.
...
| OSIS | Student council members |
| Teacher | Faculty / extracurricular advisors |
| Admin | Vice Principal of Student Affairs |
